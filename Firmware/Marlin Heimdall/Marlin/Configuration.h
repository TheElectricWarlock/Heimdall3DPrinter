...
#define STRING_VERSION_CONFIG_H __DATE__ "12-19-15" __TIME__ // build date and time
...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "RepRap Heimdall"
...
#define HOMING_FEEDRATE {80*60, 80*60, 5.5*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.00, 80.00 ,2267.72 ,100}  // default steps per unit for Ultimaker
